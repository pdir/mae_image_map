...
$GLOBALS['TL_DCA']['tl_content']['palettes']['mae_img_map'] = '{type_legend},type,headline;{source_legend},singleSRC,tl_mae_img_map_id;{image_legend},alt,title,size,imagemargin;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
